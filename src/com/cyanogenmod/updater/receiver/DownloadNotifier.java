...
public class DownloadNotifier {
    ...
    public static void notifyDownloadComplete(Context context,
        ...
        NotificationCompat.BigTextStyle style = new NotificationCompat.BigTextStyle()
                ...
                .bigText((CharSequence)context.getString(R.string.not_download_install_notice, updateUiName));
        ...
        NotificationCompat.Builder builder = createBaseContentBuilder(context, updateIntent)
                ...
                .setTicker((CharSequence)context.getString(R.string.not_download_success))
                .setStyle(style)
