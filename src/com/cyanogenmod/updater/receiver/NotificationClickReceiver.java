...
public class NotificationClickReceiver extends BroadcastReceiver{
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        // Problem statement: Start download, exit app, click on notification.  The app opens
        // but the preferece progress bar is not set appropriately, status shows as downloaded
