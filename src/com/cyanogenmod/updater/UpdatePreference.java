    ...
    private void showStyle() {
        ...
        switch (mStyle) {
            case STYLE_DOWNLOADED:
                ...
                // Changing the 'contentDescription' to improve accessibility
                mUpdatesButton.setContentDescription(getResources().getString(R.string.install_btn));
            ...
            case STYLE_DOWNLOADING:
                ...
                // Changing the 'contentDescription' to improve accessibility
                mUpdatesButton.setContentDescription(getResources().getString(R.string.cancell_btn));
                mUpdatesButton.setEnabled(true);
            ...
            case STYLE_INSTALLED:
                ...
                // Changing the 'contentDescription' to improve accessibility
                mUpdatesButton.setContentDescription(getResources().getString(R.string.installed_btn));
                mUpdatesButton.setEnabled(false);
            ...
            default:
                ...
                // Changing the 'contentDescription' to improve accessibility
                mUpdatesButton.setContentDescription(getResources().getString(R.string.download_btn));
                mUpdatesButton.setEnabled(true);
