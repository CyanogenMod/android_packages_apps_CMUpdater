...
public class UpdateCheckService extends IntentService {
    ...
    private UpdateInfo parseUpdateJSONObject(JSONObject obj, int updateType) throws JSONException {
        ...
        builder.setDownloadUrl(obj.getString("url"));
        builder.setMD5Sum(obj.getString("md5sum"));
        builder.setApiLevel(obj.getInt("api_level"));
        builder.setBuildDate(obj.getLong("timestamp"));
        builder.setType(obj.getString("channel"));
        builder.setIncremental(obj.getString("incremental"));
        UpdateInfo ui = builder.build();
