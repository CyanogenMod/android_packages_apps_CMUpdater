...
public class UpdateCheckService extends IntentService
    ...
    private void getAvailableUpdates() throws IOException {
    ...
    private UpdateInfo parseUpdateJSONObject(JSONObject obj, int updateType) throws JSONException {
        UpdateInfo ui = new UpdateInfo.Builder()
                ...
                .setIncremental(obj.getString("incremental")).build();
    ...
    private void fetchChangeLog(final UpdateInfo info, String url) {
        ...
        ChangeLogRequest request = new ChangeLogRequest(Request.Method.GET, url,
                Utils.getUserAgentString(this), new Response.Listener<String>() {
            @Override
