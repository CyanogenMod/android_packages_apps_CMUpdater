...
public class DownloadCompleteIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        Intent updateIntent = new Intent(getBaseContext(), UpdatesSettings.class);
    ...
    private String fetchDownloadPartialPath(long id) throws NullPointerException {
    ...
    private int fetchDownloadStatus(long id) throws NullPointerException {
        DownloadManager.Query query = new DownloadManager.Query();
        query.setFilterById(id);
        Cursor c = mDm.query(query);
        try {
    ...
    private void displayErrorResult(Intent updateIntent, int failureMessageResId) {
        DownloadNotifier.notifyDownloadError(getBaseContext(), updateIntent, failureMessageResId);
    }
    ...
    private void displaySuccessResult(Intent updateIntent, File updateFile) {
        ...
        if (app.isMainActivityActive()) {
            ...
            DownloadNotifier.notifyDownloadComplete(getBaseContext(), updateIntent, updateFile);
        }
    }
}
