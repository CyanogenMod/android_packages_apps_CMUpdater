...
public class Utils {
    ...
    public static void triggerUpdate(Context context, String updateFileName) throws IOException {
        ...
        /*
         * maybeTranslateEmulatedPathToInternal requires that we have a full path to a file (not just a directory)
         * and have read access to the file via both the emulated and actual paths.  As this is currently done, we
         * lack the ability to read the file via the actual path, so the translation ends up failing.  Until this
         * is all updated to download and store the file in a sane way, manually perform the translation that is
         * needed in order for uncrypt to be able to find the file.
         */
