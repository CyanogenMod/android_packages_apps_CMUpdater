...
public class UpdatesSettings extends PreferenceActivity implements
    ...
    public static final String KEY_SHOW_CAPPS = "key_show_capps";
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        menu.findItem(MENU_SYSTEM_SHOW_CAPPS).setChecked(
...
//        }
    ...
    private void refreshPreferences(LinkedList<UpdateInfo> updates) {
        ...
        for (UpdateInfo ui : updates) {
            ...
            up.setCapps(ui.getType() == UpdateInfo.Type.CAPPS);

            // Add to the list
            mUpdatesList.addPreference(up);
            if (mAutoOpenCapps && ui.getType() == UpdateInfo.Type.CAPPS) {
