...
public class AvailableUpdatesDbAdapter
{
//	private static final String TAG = "ThemeListDbAdapter";
//	
//	private static final String DATABASE_NAME = "cmupdater";
//	private static final String DATABASE_TABLE = "AvailableUpdates";
	//TODO: each Field from the UpdateInfo must be stored in the DB.
	//TODO: store the whole updateinfos to the database before discarding udpates, so a setting change will
	//work immediately
...
//	
//	public AvailableUpdatesDbAdapter(Context _context)
//	{
